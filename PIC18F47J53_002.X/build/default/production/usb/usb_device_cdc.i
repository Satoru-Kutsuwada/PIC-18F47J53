...
# 2 "<built-in>" 2
# 1 "usb/usb_device_cdc.c" 2
# 48 "usb/usb_device_cdc.c"
# 1 ".\\system.h" 1
# 23 ".\\system.h"
...
# 54 "usb/usb_device_cdc.c" 2
# 70 "usb/usb_device_cdc.c"
...
# 237 "usb/usb_device_cdc.c"
            inPipes[0].info.bits.busy = 1;
            break;
# 262 "usb/usb_device_cdc.c"
        default:
            break;
    }

}
# 297 "usb/usb_device_cdc.c"
void CDCInitEP(void)
{
...
# 346 "usb/usb_device_cdc.c"
    cdc_trf_state = 0;
}
# 421 "usb/usb_device_cdc.c"
_Bool USBCDCEventHandler(USB_EVENT event, void *pdata, uint16_t size)
{
...
# 554 "usb/usb_device_cdc.c"
void putUSBUSART(uint8_t *data, uint8_t length)
{
# 574 "usb/usb_device_cdc.c"
    {PIE2bits.USBIE = 0;};
    if(cdc_trf_state == 0)
    {
...
# 723 "usb/usb_device_cdc.c"
void putrsUSBUSART(const char *data)
{
    uint8_t len;
    const char *pData;
# 750 "usb/usb_device_cdc.c"
    {PIE2bits.USBIE = 0;};
    if(cdc_trf_state != 0)
    {
        {PIE2bits.USBIE = 1;};
