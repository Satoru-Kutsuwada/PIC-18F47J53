...
# 59 "usb/usb_device.c" 2
# 112 "usb/usb_device.c"
...
volatile BDT_ENTRY BDT[((2 + 1) * 4)] __attribute__((address(0xD00)));




volatile CTRL_TRF_SETUP SetupPkt __attribute__((address((0xD00 +(((2 + 1) * 4)*4)))));
volatile uint8_t CtrlTrfData[8] __attribute__((address(((0xD00 +(((2 + 1) * 4)*4)) + 8))));
# 218 "usb/usb_device.c"
...
# 484 "usb/usb_device.c"
void USBDeviceTasks(void)
{
    uint8_t i;
# 597 "usb/usb_device.c"
    if(USBDeviceState == ATTACHED_STATE)
    {
# 614 "usb/usb_device.c"
        if(!UCONbits.SE0)
        {
...
# 685 "usb/usb_device.c"
    ...
    {
        USBDeviceInit();
# 696 "usb/usb_device.c"
        {PIE2bits.USBIE = 1;};

        USBDeviceState = DEFAULT_STATE;
# 708 "usb/usb_device.c"
        (UIR &= 0xFE);
    }
...
# 783 "usb/usb_device.c"
    ...
    if(UIRbits.UERRIF && UIEbits.UERRIE)
    {
        ...
        {UEIR = 0;};
# 812 "usb/usb_device.c"
    }
# 822 "usb/usb_device.c"
...
void USBDeviceDetach(void)
{
...

    {
         ...
         USBDeviceState = DETACHED_STATE;
# 1375 "usb/usb_device.c"
          return;
    }
# 1396 "usb/usb_device.c"
}
# 1453 "usb/usb_device.c"
void USBDeviceAttach(void)
{
...
# 1789 "usb/usb_device.c"
   if(USBDeferINDataStagePackets == 0)
            {
                USBCtrlEPAllowDataStage();
   }
# 1814 "usb/usb_device.c"
            USBStatusStageEnabledFlag2 = 0;
            USBStatusStageEnabledFlag1 = 0;
...
# 2309 "usb/usb_device.c"
static void USBStallHandler(void)
{
# 2321 "usb/usb_device.c"
...
# 2621 "usb/usb_device.c"
    USBCtrlEPServiceComplete();
}
# 2645 "usb/usb_device.c"
static void USBCtrlTrfOutHandler(void)
{
    if(controlTransferState == 2)
    {
